...
export const HEALTH_SUB_TABS: { id: SubTab; label: string }[] = [{ id: 'health_data', label: '初始化' }, { id: 'health_target', label: '目标测算' }, { id: 'health_dashboard', label: '观星台' }, { id: 'health_report', label: '行动环' }, { id: 'readme', label: 'readme' }];
