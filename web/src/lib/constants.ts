...
export const AGGREGATE_SUB_TABS: { id: SubTab; label: string }[] = [{ id: 'tool_use', label: 'tool-use' }, { id: 'tool', label: 'tool实验场' }, { id: 'skill', label: 'skill实验场' }, { id: 'hooks_mgmt', label: 'hooks管理' }, { id: 'skills_mgmt', label: 'skills管理' }, { id: 'command_mgmt', label: 'command管理' }, { id: 'plugin_mgmt', label: '插件管理' }, { id: 'subagents_mgmt', label: 'subagents管理' }, { id: 'llm_mgmt', label: 'LLM管理' }, { id: 'prompts_mgmt', label: 'prompts管理' }, { id: 'readme', label: 'readme' }];
...
export const XAN_DB_SUB_TABS: { id: SubTab; label: string }[] = [{ id: 'the-crowd', label: 'the-crowd' }, { id: 'weather', label: '天气' }, { id: 'business_district', label: '商圈' }, { id: 'industry', label: '行业' }, { id: 'competitor', label: '竞品' }, { id: 'own_product', label: '本品' }, { id: 'sql_connect', label: 'SQL连接' }];
